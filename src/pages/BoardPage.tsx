...
import { Layout, Sparkles, LogOut } from 'lucide-react';
...
export function BoardPage() {
    ...
    const { logout, user } = useAuth(); // Destructure logout and user
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/60">Organize your workflow {user?.email && `(${user.email})`}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-4 border-l border-white/10 pl-6">
                                ...
                                <button
                                    onClick={logout}
                                    className="ml-4 p-2 bg-white/10 hover:bg-white/20 rounded-lg text-white/80 hover:text-white transition-colors"
                                    title="Sign Out"
                                >
